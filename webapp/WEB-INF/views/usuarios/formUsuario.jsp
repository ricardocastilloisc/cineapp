	...
	<div class="container theme-showcase" role="main">
		...
		<form:form action="${urlForm}" method="post" modelAttribute="usuario">
			...
			<div class="row">
				<div class="col-sm-3">
					<div class="form-group">
						<label for="cuenta">Cuenta</label> <form:input path="cuenta" type="text"
							class="form-control" id="cuenta"
							required="required" />
					</div>
				</div>
				...
				<div class="col-sm-3">
					<div class="form-group">
						<label for="pwd">Password</label> <form:input type="password"
							class="form-control" path="pwd" id="pwd" required="required" />
					</div>
				</div>
				...
				<div class="col-sm-3">
					<div class="form-group">
						<label for="telefono">Teléfono</label> <form:input type="text"
